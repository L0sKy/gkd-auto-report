...
def submit(s: requests.Session):
    new_daily = {
        ...
        # 第一针接种
        "dyzymjzqk": "4",                    # first vaccination situation  3.已接种
        "dyzjzsj": "2021-05-28",             # date of first vaccination
        "dyzwjzyy": "",
        # 第二针接种
        "dezymjzqk": "4",                    # second vaccination situation  3.已接种
        "dezjzsj": "2022-05-05",             # date of second vaccination
        "dezwjzyy": "",
        # 第三针接种
        "dszymjzqk": "4",                    # third vaccination situation  6.未接种
        "dszjzsj": "2022-05-05",             # default time
